  ...
  <div class="col-12 grid-margin mx-auto mt-3">
    <div class="card pt-2">
      <div class="card-body">
        ...
        <form class="form-sample" method="post" action="/pegawai/{{ $pegawai->id }}" enctype="multipart/form-data">
            @method('patch')
          @csrf
            <div class="row">
            <div class="col-md-6 pb-2">
                ...
                <div id="the-basics">
                <input class="typeahead col-md-6" type="text" placeholder="Input Name" name="name" value="{{ old('name',$pegawai->name) }}">
                </div>
            </div>
            <div class="col-md-6 pb-2">
                <label class="pb-2">phone</label>
                <div id="the-basics">
                <input class="typeahead col-md-6"  placeholder="Input phone" name="phone" value="{{ old('phone',$pegawai->phone) }}" autocomplete="off">
                </div>
            </div>
            </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <input class="typeahead col-md-6 " type="text" placeholder="input Adress" name="address" value="{{ old('address',$pegawai->address) }}" autocomplete="off"/>
              @error('address')
              {{ $message }}
             @enderror
            </div>
